...
namespace ars_40X {
    ...
    bool ARS_40X_CAN::receive_radar_data() {
        ...
        std::cout << "2222222222222: " << frame_id << std::endl;

        if (!read_status) {
            return false;
        }
        std::cout << "111111111111111: " << frame_id << std::endl;
        switch (frame_id) {
            case RadarState:
                memcpy(radar_state_.get_radar_state()->raw_data, data, dlc);
                send_radar_state();
                std::cout << "enter radar state!!!" << std::endl;
                break;
...
//      break;
            ...
            case Object_0_Status:
                ...
                std::cout << "send object 0 status!!!" << std::endl;
            ...
            case Object_1_General:
                ...
                std::cout << "send object 1 general!!! " << std::endl;
                break;
